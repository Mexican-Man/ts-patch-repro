...
export var PruneProgrammer;
(function (PruneProgrammer) {
    PruneProgrammer.write = (project) => (modulo) => {
    ...
    const decode = (project) => (config) => (importer) => (input, meta, explore) => {
        ...
        const unions = [];
        for (const tuple of meta.tuples.filter((t) => t.elements.some((e) => { var _a; return filter((_a = e.rest) !== null && _a !== void 0 ? _a : e); })))
            unions.push({
                type: "tuple",
    ...
    const decode_array_inline = (config) => (importer) => (input, array, explore) => FeatureProgrammer.decode_array(config)(importer)(PruneJoiner.array)(input, array, explore, [], []);
    ...
    const filter = (meta) => meta.any === false &&
        (meta.objects.length !== 0 ||
            meta.tuples.some((t) => t.elements.some((e) => { var _a; return filter((_a = e.rest) !== null && _a !== void 0 ? _a : e); })) ||
...
})(PruneProgrammer || (PruneProgrammer = {}));
