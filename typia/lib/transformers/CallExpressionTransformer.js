...
export var CallExpressionTransformer;
(function (CallExpressionTransformer) {
    CallExpressionTransformer.transform = (project) => (expression) => {
        var _a;
        const declaration = (_a = project.checker.getResolvedSignature(expression)) === null || _a === void 0 ? void 0 : _a.declaration;
        if (!declaration)
            return expression;
...
const CLI_PATH = path.resolve(path.join(__dirname, "..", "..", "..", "src", "module.ts"));
const FUNCTORS = {
    ...
    application: () => (project) => () => ApplicationTransformer.transform(project),
